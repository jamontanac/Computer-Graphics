...
//}
//
//int generate_color(int mean, int std_dev) {
//    //std::random_device rd;
//    std::mt19937 seq(42);
//    std::normal_distribution<> d( mean, std_dev );
//
...
//}
//
//void fill_random_matrix(std::vector<std::vector<std::vector<int, int, int>>>& my_array, int width, int height, int mean, int std_dev) {
//    for (int i = 0; i < height; i++) {
//        for (int j = 0; j < width; j++) {
//            for (int c = 0; c<3;c++) {
//                my_array[i][j][c]= generate_color(mean, std_dev);
//            }
//        }
//    }
//}
...
//
//    for(int i = 4; i < argc; i++) {
//        percentages.push_back(std::stof(argv[i]));
//    }
//
//    std::vector<std::vector<std::vector<int, int, int>>> final(height, std::vector<std::tuple<int, int, int>>(width));
//
//    std::ofstream f;
//    f.open(filename);
//    f << "P3\n" << width << " " << height << "\n255\n";
...
//        int w = static_cast<int>(width * cumulative_percentage);
//        int h = static_cast<int>(height * cumulative_percentage);
//        std_dev = static_cast<int>(100 * cumulative_percentage);
//        fill_random_matrix(final, w, h, mean, std_dev);
//    }
//
//    for(int i = 0; i < height; i++) {
